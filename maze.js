...
// When the user clicks the button, open the menu or modal
modelfungo = function () {
...
function drawMoves() {
  document.getElementById("move").innerHTML = "Count of Moves: " + m.getMoves();
}
// drawMoves();
